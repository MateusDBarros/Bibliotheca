...
public class Methods {
    ...
    public static void showAll(ArrayList<Book> books) {
        ...
        for (int i = 0; i < books.size(); i++) {
            if (books.get(i).rented == false) {
                System.out.printf("%-3d | %-20s | %-20s | %-20s\n", books.get(i).id, books.get(i).title, books.get(i).author, "Livre");
            }
            else {
                System.out.printf("%-3d | %-20s | %-20s | %-20s\n", books.get(i).id, books.get(i).title, books.get(i).author, "Alugado");
            }
        }
    }
    ...
    public static void show(ArrayList<Book> books, int index) {
        System.out.printf("%-3s | %-20s | %-20s | %-20s\n", "ID", "Titulo", "Autor", "Status");
        System.out.println("---------------------------------------------------");
        System.out.printf("%-3d | %-20s | %-20s\n", books.get(index).id, books.get(index).title, books.get(index).author);
    }
    ...
    public static void delete(String input, ArrayList<Book> books) {
        ...
        for (int i = 0; i < books.size(); i++) {
            if (input.equals(books.get(i).title)) {
